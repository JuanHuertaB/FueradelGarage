...
<div class="col-lg-6 col-lg-offset-3">
    <div class="well">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <s:form id="myForm" action="registrar" theme="bootstrap"
                            validate="true" cssClass="bs-example form-horizontal"
                            method="post">
                        <fieldset>
                            <legend>Formulario de Registro Contratistas</legend>

                            <s:textfield label="Nickname" name="user.name"
                                         cssClass="col-lg-11" placeholder="ingrese nombre de login" />

                            <s:textfield label="Nombre" name="user.firstName"
                                         cssClass="col-lg-11" placeholder="ingrese su nombre" />

                            <s:textfield label="Apellidos" name="user.lastName"
                                         cssClass="col-lg-11" placeholder="ingrese sus apellidos" />

                            <s:password label="Password" name="user.password"
                                        cssClass="col-lg-11" placeholder="ingrese su contraseña" />
