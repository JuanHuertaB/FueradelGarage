...
<div class="py-5 text-white bg-secondary">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="display-1">Panel de Eventos</h1>
            </div>
        </div>
    </div>
</div>
<nav class="navbar navbar-expand-md bg-secondary navbar-dark">
    <div class="container">
        <a class="navbar-brand" href="#"><b>Título del evento</b></a>
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="transition: all 0.25s;">
                <form style="opacity:10;">
                    ...
                    <div class="form-group"> <label for="InputEmail1">Descripción</label> </div>
                    <div>
