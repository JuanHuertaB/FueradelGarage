...
<nav class="navbar navbar-expand-md bg-secondary navbar-dark">
    <div class="container">
        <form class="form-inline m-0">
            <button type="submit" class="btn btn-primary">¿A quién busca?</button>
            <div class="btn-group">
                <button class="btn btn-outline-body dropdown-toggle" data-toggle="dropdown">Band</button>
...
<div class="py-5 bg-dark text-white">
    <div align="center">
        <div class="col-md-6">
            <h1 align="center" class="display-5" name="titulo de la oferta">Nombre de la banda, músico o contratista</h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <form style="opacity: 10;">
                    ...
                    <div class="form-group"> <label for="InputEmail1">Calificación:</label> </div>
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 70%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">70%</div>
                    </div>
                </form>
            </div>
            <div class="col-md-6" align="center">
                <div class="form-group">
                    <button type="submit" class="col-md-6">Ver</button>
                </div>
            </div>
        </div>
