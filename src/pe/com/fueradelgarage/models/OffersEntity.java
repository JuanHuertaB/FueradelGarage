...
public class OffersEntity extends BaseEntity {
    ...
    public Offer create(Offer offer) {
        return executeUpdate(String.format(
                ...
                getTableName(), offer.getIdEvents(), offer.getTitle(), offer.getStartTime(), offer.getEndTime(), offer.getDescription())) ?
                offer : null;
    }
    ...
    public boolean update(Offer offer) {
        return update(offer.getIdOffers(), offer.getTitle(), offer.getStartTime(), offer.getEndTime(), offer.getDescription());
    }
    ...
    public boolean erase(Offer offer) {
        return executeUpdate(String.format("DELETE FROM %s WHERE id_offers=%d",
                getTableName(), offer.getIdOffers()));
    }
}